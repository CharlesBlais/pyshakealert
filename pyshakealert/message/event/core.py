...
from pyshakealert.message.event.magnitude import Magnitude, MagnitudeUncertainty
from pyshakealert.message.event.coordinate import Coordinate, CoordinateUncertainty
from pyshakealert.message.event.depth import Depth, DepthUncertainty
from pyshakealert.message.event.origintime import OriginTime, OriginTimeUncertainty
