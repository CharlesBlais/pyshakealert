...
class Event(dict):
    ...
    def message_type(self, value: str) -> None:
        ...
        if value not in accepted:
            raise ValueError(f'Message type can only be {", ".join(accepted)}')
    ...
    def contributors(self) -> Contributors:
        ...
        ..  note::
            ...
            We need to keep the same structure, although it may seem confusing,
            in order to simplify the conversation too and form xml format.
        """
    ...
    def gm(self) -> GroundMotion:
        ...
        return GroundMotion(**value) \
            if not isinstance(value, GroundMotion) else value
