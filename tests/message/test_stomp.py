...
def client() -> Client:
    ...
    if settings.amq_username is None:
        raise ValueError('username required for stomp testing')
    if settings.amq_password is None:
        raise ValueError('password required for stomp testing')
